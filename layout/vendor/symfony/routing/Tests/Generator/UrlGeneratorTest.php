...
class UrlGeneratorTest extends TestCase
{
    ...
    public function testOptionalVariableWithNoRealSeparator()
    {
        ...
        $this->assertSame('/app.php/getSites', $generator->generate('test', array('what' => 'Themes')));
    }
    ...
    public function testRequiredVariableWithNoRealSeparator()
    {
        ...
        $this->assertSame('/app.php/getSitesSuffix', $generator->generate('test', array('what' => 'Themes')));
    }
