...
class Google_Service_DLP_GooglePrivacyDlpV2beta1RecordTransformations extends Google_Collection
{
  ...
  protected $recordSuppressionsType = 'Google_Service_DLP_GooglePrivacyDlpV2beta1RecordSuppression';
