...
class Google_Service_DLP_GooglePrivacyDlpV2beta1FieldTransformation extends Google_Collection
{
  protected $collection_key = 'fields';
  protected $conditionType = 'Google_Service_DLP_GooglePrivacyDlpV2beta1RecordCondition';
  protected $conditionDataType = '';
  protected $fieldsType = 'Google_Service_DLP_GooglePrivacyDlpV2beta1FieldId';
  ...
  protected $primitiveTransformationType = 'Google_Service_DLP_GooglePrivacyDlpV2beta1PrimitiveTransformation';
   ...
   */
  public function setPrimitiveTransformation(Google_Service_DLP_GooglePrivacyDlpV2beta1PrimitiveTransformation $primitiveTransformation)
  {
