...
if (! function_exists('url')) {
    ...
    function url($path = null, $parameters = [], $secure = null)
    {
        ...
        // to set Url of paginator with https or http
        if((string)Layout\Website\Services\ThemeService::ConfigValue("SECURE_PAGINATOR") == '0'){
            $secure =false;
        }
        elseif(Layout\Website\Services\ThemeService::ConfigValue("SECURE_PAGINATOR")){
            $secure =true;
        }
